...
<?php
  ...
  $allTable = $db->query('SELECT * FROM users',PDO::FETCH_ASSOC);
  $emailForUsername = [];
  $data = [];
  if($allTable){
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="email" name="getEmail" placeholder="email">
    </div>
  </div>
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="text" id="header" name="getHeader" placeholder="Header">
    </div>
  </div>  
  <div class="row">
    <div class="col-25">
...
<style> <?php include "./styleFile/footer.css"; ?> </style>
